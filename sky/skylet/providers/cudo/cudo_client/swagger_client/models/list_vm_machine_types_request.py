...
class ListVMMachineTypesRequest(object):
    ...
    def __init__(self, cpu_model=None, data_center_id=None, gpu=None, gpu_model=None, memory_gib=None, order_by=None, page_number=None, page_size=None, region_id=None, storage_gib=None, vcpu=None, _configuration=None):  # noqa: E501
