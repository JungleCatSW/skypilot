...
from sky.skylet.providers.cudo.cudo_client.swagger_client.api.networks_api import NetworksApi  # noqa: E501
...
class TestNetworksApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.api.networks_api.NetworksApi()  # noqa: E501
