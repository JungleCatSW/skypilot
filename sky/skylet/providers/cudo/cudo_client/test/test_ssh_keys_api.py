...
from sky.skylet.providers.cudo.cudo_client.swagger_client.api.ssh_keys_api import SSHKeysApi  # noqa: E501
...
class TestSSHKeysApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.api.ssh_keys_api.SSHKeysApi()  # noqa: E501
